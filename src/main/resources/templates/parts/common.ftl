...
<#macro page>
    ...
    <head>
        ...
        <#--defer - атрибут html, который позволяет выполнять script только после полной загрузки страницы-->
    ...
    <#--bootstrap оставляем внизу что б не сбоили интерактивные елементы-->
